...
const ArrivalMethodDeleteConfirmationModal = ({ arrivalMethod, reload, setReload, setIsShowModal }) => {

    const lang = useSelector(state => state.lang.lang)

    const [isLoading, setIsLoading] = useState(false)

    const deleteArrivalMethod = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/arrival-methods/${arrivalMethod._id}`)
        .then(response => {
            setIsLoading(false)
...
export default ArrivalMethodDeleteConfirmationModal