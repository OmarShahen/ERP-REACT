...
const PatientUpdateSurveyConfirmationModal = ({ patient, isSurveyed, reload, setReload, setIsShowModal }) => {
    ...
    const updateSurveyStatus = () => {
        setIsLoading(true)
        serverRequest.patch(`/v1/clinics-patients/${patient._id}/survey`, { isSurveyed })
        .then(response => {
            setIsLoading(false)
    ...
    return <div className="modal">
        <div className="confirmation-modal-container body-text">
            ...
            <div className="body-text confirmation-modal-body">
                <p>
                    You 're about to update the patient survey status into 
                    { 
                        isSurveyed ? 
...
export default PatientUpdateSurveyConfirmationModal