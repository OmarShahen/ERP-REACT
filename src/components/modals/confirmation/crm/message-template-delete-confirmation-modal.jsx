...
const MessageTemplateDeleteConfirmationModal = ({ messageTemplate, reload, setReload, setIsShowModal }) => {
    ...
    const deleteMessage = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/crm/messages-templates/${messageTemplate._id}`)
        .then(response => {
            setIsLoading(false)
...
export default MessageTemplateDeleteConfirmationModal