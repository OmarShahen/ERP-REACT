...
const StageDeleteConfirmationModal = ({ stage, reload, setReload, setIsShowModal }) => {
    ...
    const deleteStage = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/crm/stages/${stage._id}`)
        .then(response => {
            setIsLoading(false)
...
export default StageDeleteConfirmationModal