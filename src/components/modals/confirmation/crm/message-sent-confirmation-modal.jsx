...
const MessageSentDeleteConfirmationModal = ({ messageSent, reload, setReload, setIsShowModal }) => {
    ...
    const deleteMessage = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/crm/messages-sent/${messageSent._id}`)
        .then(response => {
            setIsLoading(false)
...
export default MessageSentDeleteConfirmationModal