...
const OpeningTimeDeleteConfirmationModal = ({ openingTime, reload, setReload, setIsShowModal }) => {
    ...
    const deleteOpeningTime = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/opening-times/${openingTime._id}`)
        .then(response => {
            setIsLoading(false)
...
export default OpeningTimeDeleteConfirmationModal