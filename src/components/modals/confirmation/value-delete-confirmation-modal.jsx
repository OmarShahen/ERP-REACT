...
const ValueDeleteConfirmationModal = ({ value, reload, setReload, setIsShowModal }) => {
    ...
    const deleteValue = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/values/${value._id}`)
        .then(response => {
            setIsLoading(false)
...
export default ValueDeleteConfirmationModal